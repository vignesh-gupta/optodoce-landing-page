  ...
  return (
    <div className="bg-white text-black">
      <section className="container mx-auto py-24 ">
        <div className="grid lg:grid-cols-2 items-center gap-8">
          <div>
            ...
            <p className="text-[#878787]">
              ...
              customers requirements. Our vision is to bring out the best in
              people, technology and processes with top-notch quality. We build
        ...
        <span className="font-extrabold text-[13rem] text-[#55b1b1] opacity-15 hidden lg:inline-block">MISSION</span>
      </section>
    </div>
  );
};
